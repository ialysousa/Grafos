...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_c2 = MeuGrafo(['Mel', 'Luara'])
        self.g_c2.adicionaAresta('amiga', 'Mel', 'Luara')
        ...
        self.g_pa = MeuGrafo(['Joao', 'Henrique', 'Luara', 'Isabel', 'Marcos'])
        self.g_pa.adicionaAresta('amizade1', 'Joao', 'Marcos')
        self.g_pa.adicionaAresta('amizade2', 'Marcos', 'Joao')
        self.g_pa.adicionaAresta('amizade3', 'Isabel', 'Joao')
        self.g_pa.adicionaAresta('amizade4', 'Luara', 'Isabel')
        self.g_pa.adicionaAresta('amizade5', 'Henrique', 'Joao')
        self.g_pa.adicionaAresta('amizade6', 'Marcos', 'Luara')
        self.g_pa.adicionaAresta('amizade7', 'Isabel', 'Henrique')
        self.g_pa.adicionaAresta('amizade8', 'Isabel', 'Henrique')
        ...
        self.g_c2_dfs_mel = MeuGrafo(['Mel', 'Luara'])
        self.g_c2_dfs_mel.adicionaAresta('amiga', 'Mel', 'Luara')
        ...
        self.g_c2_bfs_mel = MeuGrafo(['Mel', 'Luara'])
        self.g_c2_bfs_mel.adicionaAresta('amiga', 'Mel', 'Luara')
    ...
    def test_grau(self):
        ...
        self.assertEqual(self.g_pa.grau('Isabel'), 4)
        self.assertEqual(self.g_pa.grau('Marcos'), 3)
        self.assertEqual(self.g_pa.grau('Luara'), 2)
    ...
    def test_arestas_sobre_vertice(self):
        ...
        self.assertEqual(set(self.g_pa.arestas_sobre_vertice('Luara')), set(['amizade4', 'amizade6']))
    ...
    def test_dfs(self):
        ...
        self.assertEqual(self.g_c2.dfs('Mel'), self.g_c2_dfs_mel)
    ...
    def test_bfs(self):
        ...
        self.assertEqual(self.g_c2.bfs('Mel'), self.g_c2_bfs_mel)
